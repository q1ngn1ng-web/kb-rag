...
![唐君毅六种理查询后台日志](docs/images/query-front-result-philosophy.png)

**示例 1 唐君毅六种理语义缓存命中示例**

Question1: 唐君毅是如何区分六种理的

![唐君毅六种理查询后台日志](docs/images/query-front-semantic01-result-philosophy.png)

Question2: 唐君毅所提到的六种理各有什么特点？

![唐君毅六种理查询后台日志](docs/images/query-front-semantic02-result-philosophy.png)

可以看到，缓存命中下，耗时只有 0.3 秒，并且这两个问题是语义相近的，被语义缓存命中，不会被认为是一个新问题再去向量库中检索，二者返回的结果也是相同的。

**示例 1 唐君毅六种理查询后台日志**

![唐君毅六种理查询后台日志](docs/images/query-back-result-philosophy.png)
